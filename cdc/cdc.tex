...
\end{description}
Les sons et musiques sont contenus dans un .muscancer qui est en fait des .tar.gz qui contient deux dossiers : un 'music' et un 'sounds'. Le 'music' contient les musiques 'game.ogg' et 'menu.ogg'. Le dossier 'sounds' contient les sons énumérés ci-dessus au format wav.
